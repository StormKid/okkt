# okhttpkt
[ ![Version](https://api.bintray.com/packages/stokid/library/okhttpkt/images/download.svg?version=1.0.7) ](https://bintray.com/stokid/library/okhttpkt/1.0.7/link)
...
### 使用前提导入：
```gradle
implementation 'com.stormkid:okhttpkt:1.0.7'
```
